...
| `lib/iana.ts`          | The full IANA Well-Known URIs registry (112 entries, fetched 2026-08-05) + de-facto URIs. One row per suffix: standard, status, controller, date, one-line summary, optional deepDive slug.                                            |
