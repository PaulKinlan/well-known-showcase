...
- **57 endpoints** served from this host, each labelled honestly:
...
| **demo**      | 42    | Format-valid responses with illustrative values, labelled as demos in-band (e.g. the LNURL callback returns an honest "no Lightning node attached" error).                                                                                  |
...
lib/endpoints.ts     — 57 endpoint handlers, each labelled live|demo
